						...
						<table className='table product-list-table'>
							<thead className="text-center">
								<tr>
									...
									<th className="bg-body-tertiary" style={{verticalAlign: "middle"}} width="200px">Code</th>
									<th className="bg-body-tertiary" style={{verticalAlign: "middle"}} width="250px">Name</th>
									<th className="bg-body-tertiary" style={{verticalAlign: "middle"}} width="200px">Category</th>
									<th className="bg-body-tertiary" style={{verticalAlign: "middle"}} width="200px">Image</th>
